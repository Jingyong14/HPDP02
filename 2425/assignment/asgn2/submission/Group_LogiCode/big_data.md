...
<div align="center"> <kbd><img src="https://github.com/user-attachments/assets/3af27974-db69-4797-ba39-f2ed7bddb10e" alt="Figure 4.0.2" width="600"></kbd> <br><strong>Figure 4.0.2: Pandas code snippet for reading the dataset with selective columns and predefined data types.</strong> </div><br>
<div align="center"> <kbd><img src="https://github.com/user-attachments/assets/bd414beb-2978-44b9-ae23-0599eca4d1b3" alt="Figure 4.0.3" width="600"></kbd> <br><strong>Figure 4.0.3: Dask code snippet showing selective data loading and optimized data types during CSV reading.</strong> </div><br>
<div align="center"> <kbd><img src="https://github.com/user-attachments/assets/4fbb778c-bf02-4d7d-a43a-f9bc076a9bf7" alt="Figure 4.0.4" width="300"></kbd> <br><strong>Figure 4.0.4: Polars code snippet demonstrating selective column loading with Polars-specific data type handling.</strong> </div><br>
...
<div align="center"> <kbd><img src="https://github.com/user-attachments/assets/10b28d93-bb2e-4ff4-b3b9-fc2d12eb36f6" alt="Figure 4.0.5" width="400"></kbd> <br><strong>Figure 4.0.5: Polars code snippet for sampling 10% of the dataset by filtering every tenth row after dropping nulls.</strong> </div><br>
...
<div align="center"> <kbd><img src="https://github.com/user-attachments/assets/59251883-1c2b-48b1-9633-06f2f8e7c1b5" alt="Figure 4.0.7" width="600"></kbd> <br><strong>Figure 4.0.7: Pandas code snippet showing chunk-wise sampling of 10% after cleaning and datetime conversion.</strong> </div><br>
<div align="center"> <kbd><img src="https://github.com/user-attachments/assets/6354f291-5f98-43c4-9180-13947aa1ab3f" alt="Figure 4.0.8" width="600"></kbd> <br><strong>Figure 4.0.8: Output shape of the Polars sampled dataset.</strong> </div><br>
...
To improve performance with large datasets, **Dask** was used for parallel processing. It divides data into partitions and processes them across multiple CPU cores, enabling faster execution and lower memory usage. The full workflow includes column selection, data type optimization, dropping nulls, date conversion, and sampling—performed in parallel. **Figure 4.0.11** shows the complete Dask code used for this process.

<div align="center"> <kbd><img src="https://github.com/user-attachments/assets/7bc09f5c-5866-4257-aaff-6a42c658c911" alt="Figure 4.0.11" width="500"></kbd> <br><strong>Figure 4.0.11: Dask code snippet for parallel big data processing.</strong> </div><br>
